...
function logout_menu_item() {
	add_menu_page( '', 'Logout', 'read', 'logout', '__return_false', 'dashicons-external', 999 );
}
...
function my_plugin_menu() {
	add_options_page( 'Notification Options', 'Notification Options', 'manage_options', 'notification-options', 'notification_options' );
}*

/**
 Step 3. */
/*
function notification_options() {
	if ( !current_user_can( 'manage_options' ) )  {
		wp_die( __( 'You do not have sufficient permissions to access this page.' ) );
	}
	echo '<div class="wrap">';
  echo '<h1>Notification Options</h1>';
...
if ( function_exists( 'acf_add_options_page' ) ) {
	...
	acf_add_options_page(
		array(
			...
			'menu_slug'  => 'headless-notification-settings',
